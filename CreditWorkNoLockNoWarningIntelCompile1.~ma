...
!endif
# ---------------------------------------------------------------------------
PROJECT = CreditWorkNoLockNoWarningIntelCompile1.exe
OBJFILES = CreditWorkNoLockNoWarningIntelCompile1.obj
RESFILES = CreditWorkNoLockNoWarningIntelCompile1.res
RESDEPEN = $(RESFILES)
LIBFILES = 
DEFFILE = 
# ---------------------------------------------------------------------------
